...
LEGACY_DIR=${LEGACY_DIR:-${MAIN_DIR}/legacy}
MANI=${MANI:-${LEGACY_DIR}/pcloud_json_manifest.py}
PUSH=${PUSH:-${LEGACY_DIR}/pcloud_push_json_manifest_to_pcloud.py}
DELTA_CHECK=${DELTA_CHECK:-${LEGACY_DIR}/pcloud_quick_delta.py}
...
export PYTHONPATH="${LEGACY_DIR}:${MAIN_DIR}:${PYTHONPATH:-}"
