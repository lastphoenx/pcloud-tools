...
echo ""
echo "3a. Hinweis: --check-only gibt es im rtb_wrapper, nicht im direkten pcloud-wrapper"
echo "   (direkter Wrapper kennt kein --check-only/--dry-run CLI-Flag)"
echo ""
...
echo "   Hinweis: --use-delta-copy existiert derzeit NICHT als Flag im wrapper_pcloud_sync_1to1.sh"
echo ""
...
echo "     keine --check-only/--dry-run CLI-Flags"
