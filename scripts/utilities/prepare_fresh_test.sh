...
echo "   /opt/apps/pcloud-tools/main/legacy/wrapper_pcloud_sync_1to1.sh /mnt/backup/rtb_nas/$KEEP_SNAPSHOT"
echo "5c. Direkter pcloud-tools Dry-Run:"
echo "   /opt/apps/pcloud-tools/main/legacy/wrapper_pcloud_sync_1to1.sh /mnt/backup/rtb_nas/$KEEP_SNAPSHOT --dry-run"
echo "5d. Copy/Turbo erzwingen (direkter Wrapper):"
echo "   /opt/apps/pcloud-tools/main/legacy/wrapper_pcloud_sync_1to1.sh /mnt/backup/rtb_nas/$KEEP_SNAPSHOT --use-delta-copy"
echo ""
...
echo "   - Default: Smart-Logik im /opt/apps/pcloud-tools/main/legacy/wrapper_pcloud_sync_1to1.sh"
echo ""
echo "   Copy/Turbo explizit forcieren (Low-Level, ohne Wrapper):"
echo "   /opt/apps/pcloud-tools/venv/bin/python /opt/apps/pcloud-tools/main/legacy/pcloud_push_json_manifest_to_pcloud.py \\" 
